...
export const MaintenanceEmptyState: React.FC<MaintenanceEmptyStateProps> = ({
  ...
  description = 'Create your first scheduled or completed vehicle maintenance work order.',
  action,
}) => {
  return (
    <div className="flex flex-col items-center justify-center p-12 text-center rounded-2xl border border-dashed border-border bg-card/50 my-6">
      <div className="p-4 rounded-full bg-indigo-500/10 text-indigo-600 dark:text-indigo-400 mb-4">
...
export const MaintenanceErrorState: React.FC<{
  ...
  description = 'An error occurred while connecting to the fleet maintenance service.',
  onRetry,
}) => {
  return (
