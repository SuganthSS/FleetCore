...
export const NotificationTypeBadge: React.FC<NotificationTypeBadgeProps> = ({ type }) => {
  const styles: Record<string, string> = {
    ...
    AI: 'bg-purple-100 text-purple-700 dark:bg-purple-900/40 dark:text-purple-300 border-purple-200/60',
    FLEET: 'bg-emerald-100 text-emerald-700 dark:bg-emerald-900/40 dark:text-emerald-300 border-emerald-200/60',
  };
