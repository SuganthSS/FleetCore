...
export const ReportEmptyState: React.FC<{
  ...
  description = 'No report templates or history match your selected search filter criteria.',
  action,
}) => {
  return (
...
export const ReportErrorState: React.FC<{
  title?: string;
  description?: string;
  onRetry?: () => void;
}> = ({
  title = 'Failed to Load Reports Center',
  description = 'An error occurred while compiling report templates and historical data.',
  onRetry,
}) => {
  return (
