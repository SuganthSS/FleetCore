...
const STATUS_CONFIG: Record<VehicleStatus, { label: string; dot: string; badge: string }> = {
  AVAILABLE: {
    label: 'Available',
    dot: 'bg-emerald-500',
...
export const VehicleStatusBadge: React.FC<VehicleStatusBadgeProps> = ({
  ...
  return (
    <span
      className={`inline-flex items-center gap-1.5 rounded-full border font-semibold ${px} ${textSize} ${config.badge}`}
    >
