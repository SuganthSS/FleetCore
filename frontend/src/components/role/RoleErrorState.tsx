...
export const RoleErrorState: React.FC<RoleErrorStateProps> = ({ message, onRetry }) => {
  return (
    <div className="bg-red-50 border border-red-200 rounded-2xl p-8 text-center space-y-4 font-['Inter']">
      ...
      <div className="space-y-1">
        <h3 className="font-['Plus_Jakarta_Sans'] text-base font-bold text-red-900">
          Failed to Load Enterprise Roles
        </h3>
        <p className="text-xs text-red-700 max-w-md mx-auto">
          {message || 'An error occurred while fetching role permissions from the server.'}
        </p>
      </div>
