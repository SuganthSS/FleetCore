...
import { Search, Truck, Users, FileText } from 'lucide-react';
...
export const GlobalSearchPage: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-1">
              Search across vehicles, drivers, trips, shipments, maintenance logs, documents, and system alerts.
            </p>
          </div>
        </div>
      ...
      {/* Main Search Quick Categories Grid */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        >
          ...
          <p className="text-xs text-muted-foreground">
            Locate vehicles by registration plate, VIN, make, or status.
          </p>
        </div>
        ...
        >
          ...
          <p className="text-xs text-muted-foreground">
            Find drivers, CDL licenses, contact numbers, and assignments.
          </p>
        </div>
        ...
        >
          ...
          <p className="text-xs text-muted-foreground">
            Search invoices, registration permits, and compliance PDFs.
          </p>
        </div>
      </div>
